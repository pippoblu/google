#module "logsink-371355930727-logbucketsink" {
#  source  = "terraform-google-modules/log-export/google"
#  version = "~> 7.3.0"#

#  destination_uri      = module.avaloq-logging-ch-destination.destination_uri
#  log_sink_name        = "371355930727-logbucketsink"
...
#  retention_days           = 365
#  log_sink_writer_identity = module.logsink-371355930727-logbucketsink.writer_identity
#}
